<div class="card">
    ...
    <div id="collapse-{{ isset($title) ? Str::slug($title) : 'permission-heading' }}" class="collapse" aria-labelledby="heading-{{ isset($title) ? Str::slug($title) : 'permission-heading' }}" data-parent="#accordion-role-permission">
        <div class="card-body">
            <div class="row">
